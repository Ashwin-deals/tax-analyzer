...
# ── Score thresholds (Fix #9) ─────────────────────────────────────────────────
SCORE_HIGH_THRESHOLD     = 10   # → HIGH confidence
SCORE_MEDIUM_THRESHOLD   = 5    # → MEDIUM confidence
SCORE_UNCERTAIN_CUTOFF   = 3    # both below this → UNCERTAIN
SCORE_CLOSE_CALL_MARGIN  = 2    # TDS/GST within this → Needs_Review
...
SCORE_GST_GATEWAY        = 6
SCORE_GST_CMS_CARDPMT    = 5
SCORE_GST_NONROUND_AMT   = 2

# ── Direction penalties (applied when transaction is an incoming credit) ───────
PENALTY_INCOMING_TDS = -8
...
MERCHANT_KEYWORDS = [
    "card pmt", "card payment", "credit card", "debit card",
